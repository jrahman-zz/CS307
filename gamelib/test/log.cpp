...
string expected_log = R"([[{"data":{"actorID":0,"position":{"x":14,"y":2}},"type":"move"},{"data":{"actorID":0,"rotation":270},"type":"rotate"}],[{"data":{"actorID":0,"position":{"x":14,"y":1}},"type":"move"},{"data":{"actorID":0,"rotation":90},"type":"rotate"}]]
)";
